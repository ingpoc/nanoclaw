...
PROBE_TIMEOUT_SEC="${PROBE_TIMEOUT_SEC:-${VERIFY_WORKER_PROBE_TIMEOUT_SEC:-240}}"
PROBE_POLL_SEC="${PROBE_POLL_SEC:-2}"
PROBE_INFLIGHT_WINDOW_MINUTES="${PROBE_INFLIGHT_WINDOW_MINUTES:-180}"
PROBE_RUNNING_WATCHDOG_MS="${WORKER_PROBE_RUNNING_STALE_MS:-180000}"
...
Options:
  ...
  --probe-timeout-sec <n>        Probe timeout per worker lane (default: VERIFY_WORKER_PROBE_TIMEOUT_SEC or 240)
